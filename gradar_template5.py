...
parser.add_argument('--perturber_params', default=False, action='store_true', help="recovers in physical echo params instead of model params")
...
perturber_params=args.perturber_params
outdir=args.outdir
npool=args.npool
label=args.label
rand=args.rand
...
if glint_rec:
    if perturber_params:
        ...
        logger.info("Sampling in physical perturber parameters")
        # physical parameters [pending updates on prior shape and range]
        priors['b'] = bilby.core.prior.Uniform(
            minimum=1,
            maximum=5,
            name='b', latex_label='$b$', unit='$Mpc$'
        )
        priors['f_P'] = bilby.core.prior.Uniform(
            minimum=1,
            maximum=5,
            name='f_P', latex_label='$f_P$'
        )
        priors['M_P'] = bilby.core.prior.Uniform(
            minimum=1,
            maximum=10,
        ...
        priors['echo_amp'] = bilby.core.prior.Constraint(
        minimum=0.0,
        maximum=1.0,
...
# GWTC Priors
priors['a_1'] = bilby.core.prior.Uniform(minimum=0, maximum=0.99, name='a_1', latex_label='$a_1$', unit=None, boundary=None)
priors['a_2'] = bilby.core.prior.Uniform(minimum=0, maximum=0.99, name='a_2', latex_label='$a_2$', unit=None, boundary=None)
...
priors['phi_12']=bilby.core.prior.Uniform(minimum=0, maximum=6.283185307179586, name='phi_12', latex_label='$\\Delta\\phi$', unit=None, boundary='periodic')
priors['phi_jl']=bilby.core.prior.Uniform(minimum=0, maximum=6.283185307179586, name='phi_jl', latex_label='$\\phi_{JL}$', unit=None, boundary='periodic')
...
priors['theta_jn']=bilby.core.prior.Sine(minimum=0, maximum=3.141592653589793, name='theta_jn', latex_label='$\\theta_{JN}$', unit=None, boundary=None)
